...
// CODE HERE
const evenNumbers = mixedNumbers.filter(function(num, index, wholeArray){
  if(num % 2 === 0){
    return num
  }
})
...
// CODE HERE
const postTaxPrices = prices.map(function(num, index, wholeArray){
 return num * 1.07
})
...
// CODE HERE
const totalPopulation = populations.reduce(function(acc, curr, curIndex, wholeArr){
  return acc + curr
})
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter(function(pocketMonster, index, wholeArr){
